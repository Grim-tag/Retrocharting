...
- **Backend**: Optimized `consolidation.py` to use **Streaming** (`yield_per`) and Sorted Grouping logic. This massively reduces RAM usage for large datasets (126k+ items) and enables instant progress logging.
