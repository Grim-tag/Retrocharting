...
## [2026-01-07] Static Site Build Fixes

### Fixed
- **Frontend / Build**: Fixed 404 errors on PC games by increasing the `api.ts` fetch limit to cover 77,000+ items (resolved 60k limit issue).
