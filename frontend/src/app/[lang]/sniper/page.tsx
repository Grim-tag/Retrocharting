                        ...
                        <div key={item.id} className="bg-[#1f2533]/50 border border-[#2a3142] p-4 rounded-lg flex items-center gap-4 hover:border-[#09b1ba]/50 transition-colors group animate-fade-in-up">
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex justify-between items-start mb-1">
                                    <h3 className="text-white font-bold text-lg truncate group-hover:text-[#09b1ba] transition-colors pr-4">
                                        {item.title}
                                    </h3>
                                    {item.platform && item.platform !== "Unknown" && (
                                        <span className="text-xs bg-[#2a3142] text-gray-300 px-2 py-1 rounded border border-gray-600">
                                            {item.platform}
                                        </span>
                                    )}
                                </div>
